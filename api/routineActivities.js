...
const {updateRoutineActivity, canEditRoutineActivity, getRoutineActivityById, destroyRoutineActivity} = require('../db/routine_activities')
...
router.patch('/:routineActivityId', requireUser, async (req, res, next) =>{
    try {
        ...
        const canEdit = await canEditRoutineActivity(routineActivityId, currentUserId )
        const updateObj = {}
